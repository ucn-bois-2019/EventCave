...
{
    internal sealed class Configuration : DbMigrationsConfiguration<Core.Database.DatabaseContext>
    {
        ...
        protected override void Seed(Core.Database.DatabaseContext context)
        {
